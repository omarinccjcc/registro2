...
public class PersonDAO extends SQLiteOpenHelper{
    ...
    public void savePerson(Person person){
        ...
        getWritableDatabase().insert(TABLE_PERSON,null,values);
    }
    ...
    public List<Person> findPersonAll() {
        ...
        String where=null;
        Cursor cursor = getReadableDatabase().query(TABLE_PERSON,columns,where,null,null,null,null);
        Person person=null;
    ...
    public void updatePerson(Person person){
        ...
        values.put("score",person.getScore());
        values.put("photo",person.getPhoto());
        getWritableDatabase().update(TABLE_PERSON,values,"id="+person.getId(),null);
    }
